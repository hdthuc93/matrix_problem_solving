...
app.controller("itemFoundListCtrl", ['$scope', '$rootScope', '$http', 'helper', '$location', itemFoundListCtrl]);
function itemFoundListCtrl($scope, $rootScope, $http, helper, $location) {
    function init() {
        $scope.search = {
            category: "",
            location: ""
